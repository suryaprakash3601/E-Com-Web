...
exports.create = async (req, res) => {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    // Formidable v3 returns field values as arrays, extract first element
    ...
    const shipping = Array.isArray(fields.shipping) ? fields.shipping[0] : fields.shipping;
...
exports.update = async (req, res) => {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    let product = req.product;
    product = _.extend(product, normalizedFields);
